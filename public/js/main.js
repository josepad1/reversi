...
/* This code is a copy of the above */
...
socket.on('player_disconnected', function(payload){
	...
	/* Manage a message that a new player has left */
...
function  invite(who){
	...
	console.log('*** Log Message: \'invite\' payload: '+JSON.stringify(payload));
...
/* Handle uninvite functionality */
/* Copied from the invite functionality */

/* Send an uninvite message to the server */
function  uninvite(who){
	var payload = {};
	payload.requested_user = who;
	console.log('*** Log Message: \'uninvite\' payload: '+JSON.stringify(payload));
...
/* End of uninvite functionality */



/* Handle play button functionality - game start*/
/* Copied from the uninvite functionality */
